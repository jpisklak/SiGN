...
#' error metrics, a concordance coefficient, and information criteria
#' (AIC, BIC) based on a beta-distributed error model.
#'
#' The information criteria assume that the predicted values were generated by
#' a model or function with no free parameters. The only fitted parameter is
#' the precision parameter (\eqn{\phi}) of the error model, which is shared
#' across all observations.
#'
#' @param observed A numeric vector of observed values (e.g., choice
#' proportions). Values must lie within the interval (0, 1). This function
#' assumes a beta-distributed error model, which is not defined at 0 or 1.
#' @param predicted A numeric vector of predicted values. Must be the same length as `observed`, and also constrained to the interval (0, 1).
