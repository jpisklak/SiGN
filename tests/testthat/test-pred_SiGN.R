test_that("pred_SiGN returns correct values for standard input", {
  ...
  expect_equal(pred_SiGN(r1 = 1, r2 = 1, dr1 = 0.5, dr2 = 0.5), 0.5)

  # Different reinforcement and delay reduction → 0.8
  expect_equal(pred_SiGN(r1 = 2, r2 = 1, dr1 = 0.4, dr2 = 0.2), 0.8)

  # Lower DR for alt1 → closer to 0
  expect_equal(pred_SiGN(r1 = 1, r2 = 1, dr1 = 0.2, dr2 = 0.8), 0.2)
})

test_that("pred_SiGN handles edge cases with DR sign reversal", {
  # dr1 > 0, dr2 < 0 → force prediction to 1
  expect_equal(pred_SiGN(r1 = 1, r2 = 1, dr1 = 0.5, dr2 = -0.1), 1)

  # dr1 < 0, dr2 > 0 → force prediction to 0
  expect_equal(pred_SiGN(r1 = 1, r2 = 1, dr1 = -0.1, dr2 = 0.5), 0)
})
...
test_that("pred_SiGN is vectorised", {
  ...
  result <- pred_SiGN(r1, r2, dr1, dr2)
