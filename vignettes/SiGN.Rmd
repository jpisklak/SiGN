...
To illustrate, consider the experimental setup from Stagner & Zentall (2010), shown in Figure 1.
...
This procedure involves 16 parameters to describe the contingency, plus 2 additional parameters specific to the SiGN model—making a total of 18. To speed up the process of entering these values, the `choice_params()` function includes several pre-defined profiles: `"zentall"`, `"kendall"`, and `"fantino"`.
