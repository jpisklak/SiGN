...
A good understanding of R is also required to follow the examples and make full use of the package's functionality.
...
<figure style="float: center; padding: 10px; width: 70%;">
  <img src="images/stag_zen_2010.png" style="width: 100%;" />
  <figcaption style="text-align: center;"><strong>Figure 1.</strong> Stagner & Zentall (2010) contingencies</figcaption>
</figure>
