...
1. A **linear regression model** fitted to the observed vs predicted values, to provide a visual summary of their relationship alongside the 1:1 reference line.
...
stats_lin <- paste(reg_eqn, Rsq_lin_fit_txt)
