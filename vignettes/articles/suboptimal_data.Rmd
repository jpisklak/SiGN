...
The full, unfiltered dataset can be accessed via `subopt_full`. For model evaluation, however, Dunn et al. (2024) focused on a curated subset: studies involving **pigeons** and **starlings**, as these species had the most robust and consistently replicated findings. This filtered data set is available in the *SiGN* package as `subopt_avian`.
